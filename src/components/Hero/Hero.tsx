...
import { staggerContainer, fadeUp, slideInRight, textRevealMask } from '@/lib/motion';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div variants={textRevealMask} className="overflow-hidden">
              <h1 className="text-4xl md:text-5xl lg:text-display font-bold text-primary">
                Precision Masterbatch
                <br />
                <span className="text-accent-steel">& Additive Solutions</span>
              </h1>
            </motion.div>
            ...
            >
              Partner with a global leader in polymer colour and additive technology. 
              We deliver consistent, high-performance formulations engineered for 
            ...
            >
              <p className="text-caption text-muted-foreground mb-4">Trusted by leading manufacturers worldwide</p>
              <div className="flex flex-wrap gap-6 items-center opacity-50">
                {['Global OEM', 'PackCorp', 'TechPipe', 'FiberMax'].map((name) => (
                  <span key={name} className="font-technical text-sm font-medium text-muted-foreground tracking-wider">
                    {name}
                  </span>
                ))}
              </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-caption text-muted-foreground">Custom Formulations</p>
                  </div>
                </div>
              </motion.div>
